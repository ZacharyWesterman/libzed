...
Currently supports compiling on Linux and Windows only, as those are the only systems I have. ¯\\\_(ツ)\_/¯
I think it should compile on any flavor of these OS's, the only requirements are **make** and **g++** that supports *at least* C++11
