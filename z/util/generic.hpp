...
public:
	 ...
	 *
	 * @throws std::exception if the current type is not a string.
	 ...
	 *
	 * @throws std::exception if the current type is not an array.
	 ...
	 * @note When comparing generics of array types, <B>all</B> sub-elements may be
	 * compared!
	 */
